...
public final class FilterUtils {
    ...
    /**
     *
     * @param specialUsers all the special users, such as hosts and artists
     * @param name artist name
     * @param type type of the user
     * @return returns the searched artists
     */
    public static ArrayList<SpecialUsers> filterArtists(final ArrayList<SpecialUsers> specialUsers,
                                                        final String name,
                                                        final String type) {
        ArrayList<SpecialUsers> results = new ArrayList<>();
        for (SpecialUsers specialUsers1 : specialUsers) {
            if (specialUsers1.getUsername().startsWith(name)
                    && specialUsers1.getType().equals(type)) {
                results.add(specialUsers1);
            }
        }
        return results;
    }
